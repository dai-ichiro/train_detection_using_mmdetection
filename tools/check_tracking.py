...
def main():
    ...
    parser.add_argument('--config', type=str, default='models/siamese_rpn_r50_20e_lasot.py', help='Config file')
    parser.add_argument('--input', help='input video file')
    parser.add_argument('--output', help='output video file (mp4 format)')
    parser.add_argument('--checkpoint', type=str, default='models/siamese_rpn_r50_20e_lasot_20220420_181845-dd0f151e.pth', help='Checkpoint file')
    parser.add_argument(
